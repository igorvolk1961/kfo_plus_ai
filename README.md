...
![Главное окно КФО. Структура виртуальных папок. Перечень типов информационных объектов. Перечень метаданных](images/метаданные_ТИО.png)

![Конструктор алгоритмов. Алгоритм «Выполнение запросов к ИИ-помощнику должностного лица»](images/алгоритм.png)

![Конструктор алгоритмов. Блоки, реализующие алгоритм «Выполнение запросов к ИИ-помощнику должностного лица»](images/алгоритмы_ТИО.png)

![Карточка информационного объекта «T-pro-it-2.0 VseLLN»](images/Карточка_ИО_настроек_доступа.png)

![Карточка информационного объекта «Стандартная настройка запросов»](images/Карточка_ИО_настроек_запросов.png)
