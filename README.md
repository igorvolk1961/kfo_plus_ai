...
При разработке Конструктора алгоритмов за основу была взят opensource-проект Snap! BYOB.
...
- Проект использует фреймворк [SGR Agent Core](https://github.com/vamplabAI/sgr-agent-core) от сообщества neuraldeep
- Разработано в рамках работы с файловым хранилищем КФО
