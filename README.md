...
- **Интеграцию с корпоративным файловым обменником (КФО)** средствами low-code оркестратора


## Пример настройки ИИ-помощника ## 

КФО. Перечень метаданных
![Перечень метаданных](images/метаданные_ТИО.png)

КФО. Перечень алгоритмов
![Перечень алгоритмов](images/алгоритмы_ТИО.png)

Low-code скрипт выполнения запросов к ИИ-помощнику
![Алгоритм выполнения запросов к ИИ-помощнику](images/алгоритм.png)

Блоки low-code скрипта выполнения запросов к ИИ-помощнику
![Блоки, реализующие алгоритм вполнения запросов к ИИ-помощнику](images/реализация_блоков_алгоритма.png)

Карточка настроек доступа
![Карточка настроек доступа](images/Карточка_ИО_настроек_доступа.png)

Карточка настроек запросов
![Карточка настроек запросов](images/Карточка_ИО_настроек_запросов.png)


## Пример работы с ИИ-помощником ##

Карточка запросов к ИИ-помощнику должностного лица
![Карточка информационного объекта «Запрос к ИИ-помощнику должностного лица»](images/Карточка_ИО_диалога.png)

Карточка ответов ИИ-помощника
...
FastAPI-сервис ИИ-Помощника по работе с документами
