...
Интеграция AI-компонентов для работы с файловым хранилищем КФО (Корпоративный файловый обменник). Проект объединяет несколько специализированных модулей для создания интеллектуальной системы обработки документов с использованием RAG (Retrieval-Augmented Generation) и агентных технологий.
...
- **Интеграцию с файловым хранилищем КФО** для работы с информационными объектами 
...
Главное окно КФО. Структура виртуальных папок. Перечень типов информационных объектов. Перечень метаданных
https://github.com/igorvolk1961/kfo_plus_ai/blob/main/images/метаданные ТИО.png

Главное окно КФО. Структура виртуальных папок. Перечень типов информационных объектов. Перечень алгоритмов
images/метаданные ТИО.png

Конструктор алгоритмов. Алгоритм «Выполнение запросов к ИИ-помощнику должностного лица»
images/алгоритм.png

Конструктор алгоритмов. Блоки, реализующие алгоритм «Выполнение запросов к ИИ-помощнику должностного лица».
images/алгоритмы ТИО.png

Карточка информационного объекта «T-pro-it-2.0 VseLLN»
images/Карточка ИО настроек доступа.png

Карточка информационного объекта «Стандартная настройка запросов»
images/Карточка ИО настроек запросов.png


## Пример работы с ИИ-помощником ##

Карточка информационного объекта «Запрос к ИИ-помощнику должностного лица»
images/Карточка ИО диалога.png

Карточка информационного объекта «Ответ»
https://github.com/igorvolk1961/kfo_plus_ai/blob/1ee69758e2320515a2d2ee332f9ed607b2541ae6/images/%D0%BE%D1%82%D0%B2%D0%B5%D1%82.png
