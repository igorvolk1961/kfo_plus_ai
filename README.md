...
![Главное окно КФО. Структура виртуальных папок. Перечень типов информационных объектов. Перечень метаданных (images/метаданные ТИО.png)]

![Главное окно КФО. Структура виртуальных папок. Перечень типов информационных объектов. Перечень алгоритмов (images/метаданные ТИО.png)]

![Конструктор алгоритмов. Алгоритм «Выполнение запросов к ИИ-помощнику должностного лица» (images/алгоритм.png)]

![Конструктор алгоритмов. Блоки, реализующие алгоритм «Выполнение запросов к ИИ-помощнику должностного лица»(images/алгоритмы ТИО.png)]

![Карточка информационного объекта «T-pro-it-2.0 VseLLN» (images/Карточка ИО настроек доступа.png)]

![Карточка информационного объекта «Стандартная настройка запросов» (images/Карточка ИО настроек запросов.png)]


## Пример работы с ИИ-помощником ##

![Карточка информационного объекта «Запрос к ИИ-помощнику должностного лица» (images/Карточка ИО диалога.png)]

![Карточка информационного объекта «Ответ» (images/%D0%BE%D1%82%D0%B2%D0%B5%D1%82.png)]
